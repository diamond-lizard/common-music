...
public:
  ...
  CodeEditorWindow(juce::File file, juce::String text=juce::String::empty, int synt=0, juce::String title=juce::String::empty) ;
  ~CodeEditorWindow () ;
  ...
  void setWindowTitle(juce::String title=juce::String::empty);
  ...
  // static methods
  static void openFile(juce::File file=juce::File::nonexistent);
  static void newFile(juce::String title=juce::String::empty, int synt=TextIDs::Empty, juce::String content=juce::String::empty);
